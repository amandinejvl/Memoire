...
def check_args(file: str, model: str) -> bool:
    ...
    if model not in ['llama-2-7b','llama-2-13b']:
        print("Modèle inconnu. Choisissez llama-2-7b ou llama-2-13b.")
        valid_args = False
...
def main():
    ...
    parser.add_argument("-m", "--model", type=str, help="Nom du modèle ('llama-2-7b' ou 'llama-2-13b')")
