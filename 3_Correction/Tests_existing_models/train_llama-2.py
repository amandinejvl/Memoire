...
def main(args):
    ...
    output_dir = os.path.join('AJ_llama_model', f'{args.model}-ocr')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--model', type=str, choices=['llama-2-7b', 'llama-2-13b', 'llama-2-70b'],
    ...
    parser.add_argument('-d', '--data', type=str, help='Path to training data')
